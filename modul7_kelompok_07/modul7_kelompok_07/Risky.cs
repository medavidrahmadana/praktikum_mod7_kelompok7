...
class DataMahasiswa_13022130056
{
    ...
    public static DataMahasiswa_13022130056 ReadJSON(string fileName)
    {
        string jsonString = File.ReadAllText(fileName);
        DataMahasiswa_13022130056 mahasiswa = JsonSerializer.Deserialize<DataMahasiswa_13022130056>(jsonString);
